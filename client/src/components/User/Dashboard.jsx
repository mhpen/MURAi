      ...
      >
        <Box sx={{ 
          ...
          <List>
            <ListItem>
              <ListItemIcon>
                <Moon sx={{ color: settings.darkMode ? 'white' : 'black' }} />
              </ListItemIcon>
            ...
            <ListItem>
              <ListItemIcon>
                <Gauge sx={{ color: settings.darkMode ? 'white' : 'black' }} />
              </ListItemIcon>
              <ListItemText 
            ...
            <ListItem>
              <ListItemIcon>
                <Palette sx={{ color: settings.darkMode ? 'white' : 'black' }} />
              </ListItemIcon>
            ...
            <ListItem>
              <ListItemIcon>
                <Accessibility sx={{ color: settings.darkMode ? 'white' : 'black' }} />
              </ListItemIcon>
              <ListItemText 
